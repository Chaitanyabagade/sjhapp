...
const Dashboard = () => {
  ...
  return (
    <div className='h-fit'>
      ...
      <div className="overflow-scroll dashboard-page flex-wrap justify-center grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(300px,1fr))] md:grid-cols-[repeat(auto-fill,minmax(300px,1fr))]  lg:grid-cols-[repeat(auto-fill,minmax(400px,1fr))]">
